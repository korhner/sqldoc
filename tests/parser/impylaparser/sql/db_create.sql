...
CREATE TABLE sql_doc_two_tables.empty_not_partitioned_no_comments (
	id INTEGER
)
STORED AS PARQUET;

CREATE TABLE sql_doc_two_tables.empty_partitioned_comments (
...
CREATE TABLE sql_doc_two_tables.empty_not_partitioned_comments (
	id INTEGER COMMENT 'Id field.'
)
